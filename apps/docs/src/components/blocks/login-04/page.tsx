...
export default function Login04Page() {
  return (
    <div className="flex min-h-screen w-full items-center justify-center p-6 md:p-10 bg-zinc-950">
      <Card className="w-full max-w-4xl bg-zinc-900/50 border-border overflow-hidden p-0 grid md:grid-cols-2">
        <div className="p-6 md:p-8 space-y-4 text-left flex flex-col justify-center">
          <div className="space-y-1 text-center">
            <h2 className="text-2xl font-bold text-white">Welcome back</h2>
            <p className="text-xs text-muted-foreground">
              Login to your Vibe Inc account
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <Button
              variant="outline"
              className="flex items-center justify-center h-9 bg-zinc-800/40 border-border hover:bg-zinc-800 text-white cursor-pointer"
            >
              <svg
        ...
        <div className="relative hidden bg-zinc-900 border-l border-border md:block overflow-hidden h-full">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-center p-8 bg-gradient-to-tr from-primary/10 via-transparent to-primary/5">
            <span className="h-10 w-10 rounded-lg bg-primary text-primary-foreground font-black text-lg flex items-center justify-center mb-4">
              V
            </span>
            <h3 className="text-sm font-semibold text-white uppercase tracking-widest font-mono mb-1">
              Vibe Workspace Node
            </h3>
            <p className="text-[11px] text-muted-foreground max-w-xs leading-relaxed font-sans">
              Enter credentials to securely authenticate into the cloud host and
              synchronize developer config packages.
            </p>
          </div>
        </div>
      </Card>
