...
function UserMenu({ user }: { user: typeof data.user }) {
  const { isMobile } = useSidebar()
          ...
          <DropdownMenuTrigger asChild>
            ...
            >
              <Avatar className="h-8 w-8 rounded-lg">
                ...
                <AvatarFallback className="rounded-lg">VU</AvatarFallback>
              </Avatar>
              <div className="grid flex-1 text-left text-sm leading-tight">
...
export function SidebarDemo() {
  return (
    <div className="relative flex h-[460px] w-full items-stretch rounded-lg border border-border bg-background overflow-hidden">
      <SidebarProvider className="h-full min-h-0">
        ...
        <SidebarInset>
          ...
          <div className="flex flex-1 flex-col gap-4 p-4 bg-zinc-950">
            {/* Empty content panel */}
          </div>
        </SidebarInset>
      </SidebarProvider>
