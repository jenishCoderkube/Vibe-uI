...
<ComponentPreview sandbox="sidebar">
  <SidebarDemo />
...
<Installation name="sidebar" vibeDeps="button, input, separator, drawer, skeleton, tooltip" npmDeps="lucide-react @radix-ui/react-slot tailwind-variants clsx tailwind-merge">
...
<PropsTable title="Sidebar">
  <PropRow
    prop="side"
    type='"left" | "right"'
    default='"left"'
    description="The side of the screen the sidebar should appear on."
  />
  <PropRow
    prop="variant"
    type='"sidebar" | "floating" | "inset"'
    default='"sidebar"'
    description="The visual variant of the sidebar layout."
  />
  <PropRow
    prop="collapsible"
    type='"offcanvas" | "icon" | "none"'
    default='"offcanvas"'
    description="How the sidebar should collapse when the trigger is toggled."
  />
</PropsTable>
