...
<Installation name="form" npmDeps="react-hook-form @hookform/resolvers zod" vibeDeps="label input button switch">
...
<ComponentPreview name="form" vibeDeps="radio-group, select, slider, checkbox">
  <SignupFormDemo />
