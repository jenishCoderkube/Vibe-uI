...
export default function ToastDemoGlass() {
  return (
    <ToastProvider>
      <div className="p-4 bg-muted/20 border border-border/40 rounded-lg max-w-sm w-full">
...
export default function ToastDemoRetro() {
  return (
    <ToastProvider>
      <div className="p-4 bg-muted/20 border border-border/40 rounded-lg max-w-sm w-full">
...
export default function ToastDemoGlow() {
  return (
    <ToastProvider>
      <div className="p-4 bg-muted/20 border border-border/40 rounded-lg max-w-sm w-full">
...
export default function ToastDemoInteractiveTrigger() {
  ...
  return (
    <div className="flex flex-col items-center gap-3 w-full">
      ...
      <ToastProvider>
        ...
        <ToastViewport className="relative bottom-auto right-auto top-auto p-0 max-w-full z-0 mt-3 flex flex-col gap-2" />
      </ToastProvider>
    </div>
  )
}
...
export default function ToastDemoAction() {
  return (
    <ToastProvider>
      <div className="p-4 bg-muted/20 border border-border/40 rounded-lg max-w-sm w-full">
        <Toast open={true}>
...
export default function ToastDemoDestructive() {
  return (
    <ToastProvider>
      <div className="p-4 bg-muted/20 border border-border/40 rounded-lg max-w-sm w-full">
...
export default function ToastDemoLoading() {
  return (
    <ToastProvider>
      <div className="p-4 bg-muted/20 border border-border/40 rounded-lg max-w-sm w-full">
        <Toast open={true}>
...
export default function ToastDemoVolume() {
  return (
    <ToastProvider>
      <div className="p-4 bg-muted/20 border border-border/40 rounded-lg max-w-sm w-full">
...
export default function ToastDemoVerification() {
  return (
    <ToastProvider>
      <div className="p-4 bg-muted/20 border border-border/40 rounded-lg max-w-sm w-full">
