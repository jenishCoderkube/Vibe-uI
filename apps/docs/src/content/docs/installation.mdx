...
<Callout type="tip" title="Quick Automated Setup">
...
<FrameworkGrid>
  <FrameworkCard
    ...
    title="Next.js"
    description="Full-stack Next.js App Router setup with Tailwind CSS & TypeScript."
    badge="Recommended"
    icon={
  ...
  <FrameworkCard
    ...
    title="Vite"
    description="Fast Single Page Application setup using Vite, React, and `@tailwindcss/vite`."
    badge="Popular"
    icon={
      <svg className="h-6 w-6 text-foreground" viewBox="0 0 24 24" fill="currentColor">
  ...
  <FrameworkCard
    ...
    title="Manual Setup"
    description="Manually configure CSS tokens, path aliases, and utilities into an existing codebase."
    badge="Custom"
    icon={
