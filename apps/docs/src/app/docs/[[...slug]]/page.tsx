...
const mdxComponents = {
  ...
  ToggleToolbar: ToggleDemos.ToggleToolbar,
  ToggleMute: ToggleDemos.ToggleMute,
  ToggleBookmark: ToggleDemos.ToggleBookmark,
  TogglePin: ToggleDemos.TogglePin,
  ToggleCyberGlitch: ToggleDemos.ToggleCyberGlitch,
  ToggleGridList: ToggleDemos.ToggleGridList,
  ToggleBrutalistGrid: ToggleDemos.ToggleBrutalistGrid,
  ToggleStar: ToggleDemos.ToggleStar,
  ToggleActiveUser: ToggleDemos.ToggleActiveUser,
